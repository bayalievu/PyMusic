...
if __name__ == "__main__":
	...
	cursor = conn.cursor()
		...
		if melodyAddedYesterday():
			...
			cursor.execute("""SELECT * FROM fingerprint where status='N' and date_played>=%s and date_played<=%s and radio_id not in (10,11,12,13,14) order by radio_id,date_played,time_played""",(sevenDaysAgo,getNowDate()))
